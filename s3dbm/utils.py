...
# def get_object_final(obj_key: str, bucket: str, s3: botocore.client.BaseClient = None, public_url: HttpUrl=None, buffer_size: int=512000, read_timeout: int=120, provider: str=None, compression: bool=True, cache: MutableMapping=None, return_bytes=False):
#     """
...
# def put_object_s3(s3: botocore.client.BaseClient, bucket: str, obj_key: str, file_obj: [io.BufferedIOBase, bytes], buffer_size: int=512000, compression=True):
#     """
